...
protocol TTDAssetZoomableViewDelegate: class {
    func ypAssetZoomableViewDidLayoutSubviews(_ zoomableView: TTDAssetZoomableView)
    func ypAssetZoomableViewScrollViewDidZoom()
    func ypAssetZoomableViewScrollViewDidEndZooming()
}

final class TTDAssetZoomableView: UIScrollView {
    public weak var myDelegate: TTDAssetZoomableViewDelegate?
    public var cropAreaDidChange = {}
    public var isVideoMode = false
    public var photoImageView = UIImageView()
    public var videoView = TTDVideoView()
    public var squaredZoomScale: CGFloat = 1
    public var minWidth: CGFloat? = TTDConfig.library.minWidthForItem
    ...
    public func applyStoredCropPosition(_ scp: TTDLibrarySelection) {
    ...
    public func setVideo(_ video: PHAsset,
                         ...
                         storedCropPosition: TTDLibrarySelection?,
    ...
    fileprivate func calculateSquaredZoomScale() -> CGFloat {
        guard let image = assetImageView.image else {
            print("TTDAssetZoomableView >>> No image"); return 1.0
        }
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        backgroundColor = TTDConfig.colors.assetViewBackgroundColor
...
extension TTDAssetZoomableView: UIScrollViewDelegate {
    ...
    func scrollViewDidEndZooming(_ scrollView: UIScrollView, with view: UIView?, atScale scale: CGFloat) {
        ...
        // prevent to zoom out
        if TTDConfig.library.onlySquare && scale < squaredZoomScale {

...
public class TTDCameraVC: UIViewController, UIGestureRecognizerDelegate, TTDPermissionCheckable {
    ...
    public required init() {
        self.v = TTDCameraView(overlayView: TTDConfig.overlayView)
        super.init(nibName: nil, bundle: nil)
        title = TTDConfig.wordings.cameraTitle
        tabBarItem.image = imageFromBundle("cameraUnselected")
        tabBarItem.selectedImage = imageFromBundle("cameraSelected")
        TTDDeviceOrientationHelper.shared.startDeviceOrientationNotifier { _ in }
    }
    ...
    deinit {
        TTDDeviceOrientationHelper.shared.stopDeviceOrientationNotifier()
    }
    ...
    func cropImageToSquare(_ image: UIImage) -> UIImage {
        let orientation: UIDeviceOrientation = TTDDeviceOrientationHelper.shared.currentDeviceOrientation

...
extension TTDPhotoCapture {
    ...
    private func setupCaptureSession() {
        ...
        let cameraPosition: AVCaptureDevice.Position = TTDConfig.usesFrontCamera ? .front : .back
    ...
    func setCurrentOrienation() {
        ...
        let orientation = TTDDeviceOrientationHelper.shared.currentDeviceOrientation
        switch orientation {
        case .portrait:
